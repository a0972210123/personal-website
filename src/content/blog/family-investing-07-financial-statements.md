...
description: 損益表、資產負債表、現金流量表的結構與關聯；從第一線的營收、成本，一路計算到 EPS、ROIC、本益比，用杜邦分析樹狀圖完整呈現所有投資指標的計算脈絡。
pubDate: 2026-06-28
lang: zh
...
<div class="dtabs">
<div class="dtab-nav">
  <button class="dtab-btn dtab-active" data-panel="panel-tree">📐 杜邦公式樹</button>
  <button class="dtab-btn" data-panel="panel-flow">🔗 三表關聯圖</button>
</div>

<div class="dtab-panel dtab-active" id="panel-tree">
<p style="font-size:0.85rem;color:var(--color-text-muted);margin:0 0 0.9rem;">杜邦分析（DuPont Analysis）把 ROE 拆成三個相乘的因子，每個因子再往下接到三張表的原始數字；樹頂則用 P/B ＝ P/E × ROE 接上市場估值。由上往下讀：</p>
...
<div class="dpt-extra">
  <div class="dpt-extra-title">杜邦樹之外的常用指標（同樣源自三張表，關聯見「三表關聯圖」）</div>
...
<div class="callout">
  ...
  <code>ROE = 淨利率 × 資產周轉率 × 權益乘數（財務槓桿）</code><br>
...
- 所有投資指標都能追溯到最底層的營收和成本數字——杜邦樹是你的導航地圖
